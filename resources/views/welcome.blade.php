        ...
        <div class="min-h-screen bg-gradient-to-b from-slate-50 via-white to-gray-100">
            <header class="border-b border-gray-200 bg-white/90 backdrop-blur">
                <div class="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8">
                    <div>
                        <p class="text-xs font-semibold uppercase tracking-[0.3em] text-gray-500">{{ __('Public Catalog') }}</p>
                        <h1 class="mt-1 text-xl font-semibold text-gray-900">{{ config('app.name', 'Budget System') }}</h1>
                    </div>
